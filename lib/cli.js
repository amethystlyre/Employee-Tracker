...
const {generateDepNameList,generateRoleTitleList} = require("../helper/dataConverter.js");
        ...
        .then(async (answer)=>{
            ...
            switch(answer.action){
                case "View All Employees":
                    try{
                        await new GetEmpData().queryAllDetails().then((result)=>{console.table(result)});
                    }
                    catch (e){
                        console.error("err: "+e);
                    }
                ...
                case "View All Roles":
                    try{
                        await new GetRoleData().queryAllDetails().then((result)=>{console.table(result)});
                    }
                    catch (e){
                        console.error("err: "+e);
                    }
